(() => {
  ...
  function ApplyMoveInfo(target) {
    ...
    moveAccuracyBaseElement.textContent = getMoveBaseAccuracy(move2.Accuracy1, move2.Accuracy2, move2.MaxBoost).toFixed(2) + "%";
